...
public class ExampleFlow {
    ...
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public Initiator(int iouValue, Party otherParty,byte[] publicKey, byte[] signedMessage) {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            IOUState iouState = new IOUState(iouValue, me, otherParty,this.publicKey,this.signedMessage, new UniqueIdentifier());
